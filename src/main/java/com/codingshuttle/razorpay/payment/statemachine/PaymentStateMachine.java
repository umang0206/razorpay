...
import com.codingshuttle.razorpay.common.execptions.InvalidStateTransitionException;
...
public class PaymentStateMachine {
    ...
    private static final Map<Transition, PaymentStatus> TRANSITION =  Map.ofEntries(
            ...
            Map.entry( new Transition(PaymentStatus.CAPTURED, PaymentEvent.SETTLED), PaymentStatus.SETTLED),
